...
pub fn analyze_live_range(irgm: &mut IRGraphManager, root_node: NodeIndex, exit_node: NodeIndex) {
    ...
    println!(
        "{:?}",
        display::Dot::with_config(&interference_graph, &[display::Config::EdgeNoLabel])
    );
